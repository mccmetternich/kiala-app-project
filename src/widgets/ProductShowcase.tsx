...
export default function ProductShowcase({
  ...
  return (
    <div className="bg-gradient-to-br from-primary-50 via-white to-accent-50 rounded-2xl shadow-xl border border-gray-100 overflow-hidden my-8">
              ...
              <div className="absolute bottom-4 left-4 bg-white/95 backdrop-blur px-3 py-2 rounded-xl shadow-lg flex items-center gap-2">
                <div className="flex">
                  {[...Array(5)].map((_, idx) => (
                    <Star
                      key={idx}
                      className={`w-4 h-4 ${idx < ratingStars ? 'text-primary-400 fill-primary-400' : 'text-gray-300'}`}
                    />
                  ))}
                </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex">
                      {[...Array(5)].map((_, idx) => (
                        <Star key={idx} className="w-3 h-3 text-primary-400 fill-primary-400" />
                      ))}
                    </div>

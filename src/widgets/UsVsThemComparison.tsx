      ...
      <div className="grid md:grid-cols-2 gap-6 md:gap-8">
        ...
        <div className="relative bg-gradient-to-br from-primary-50 via-primary-50 to-accent-50 rounded-2xl p-6 border-2 border-primary-200 shadow-lg">
          ...
          <div className="absolute -top-3 -left-3 z-10">
            <div className="bg-gradient-to-r from-accent-800 via-accent-600 to-accent-500 text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg flex items-center gap-1.5">
          ...
          <div className="space-y-4">
            {column1Features.map((feature, index) => (
              ...
              >
                <div className="flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center shadow-md" style={{ background: 'linear-gradient(135deg, #9caf88, #8b9467)' }}>
      ...
      {showCta && (
        <div className="mt-10 text-center">
          <TrackedLink
            ...
            className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-primary-500 to-accent-500 text-white font-bold text-lg py-4 px-10 rounded-xl shadow-lg text-center"
          >
            {finalCtaText}
          </TrackedLink>

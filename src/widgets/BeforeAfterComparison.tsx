...
export default function BeforeAfterComparison({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl overflow-hidden my-8 border border-gray-100">
      ...
      <div className="bg-gradient-to-r from-accent-800 to-accent-500 text-white px-6 py-3 flex items-center justify-between">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="absolute inset-0">
              ...
              />
              <div className="absolute top-4 right-4 bg-gradient-to-r from-accent-800 to-accent-500 text-white px-3 py-1 rounded-full text-sm font-bold shadow-lg">
                AFTER
              </div>
            </div>

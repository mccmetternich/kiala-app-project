...
export default function NewsletterSignup({
  ...
  return (
    <div id="newsletter" className="bg-gradient-to-br from-accent-800 via-accent-900 to-accent-800 rounded-3xl p-8 lg:p-12 my-12 text-white shadow-2xl scroll-mt-24">

...
export default function TopTenList({
  ...
  const getIcon = (index: number) => {
    ...
    return (
      <div className="w-8 h-8 bg-gradient-to-br from-accent-800 to-accent-500 text-white rounded-full flex items-center justify-center font-bold text-sm shadow-md">
        {index + 1}
      </div>
    );
  };
      ...
      <div className="p-5">
        ...
        <div className="mt-6 text-center">
          <TrackedLink
            ...
            className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-accent-800 to-accent-500 hover:from-accent-900 hover:to-accent-600 text-white font-bold py-3 px-8 rounded-xl transition-all shadow-lg hover:shadow-xl text-center"
          >
            {ctaText}
          </TrackedLink>

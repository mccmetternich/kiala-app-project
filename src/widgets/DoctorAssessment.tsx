          ...
          <div className="md:hidden">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-primary-600 text-xs font-medium">{doctorCredentials}</p>
              </div>
            </div>
                ...
                return (
                  <p
                    ...
                    className={`text-base leading-relaxed ${
                      isHighlight
                        ? 'text-primary-800 font-semibold bg-primary-100/50 p-3 rounded-lg border-l-4 border-primary-500'
                        : 'text-gray-700'
                    }`}
                  >
                    {paragraph}
            ...
            <div className="mt-4 pt-3 border-t border-primary-100">
              <p className="text-primary-700 font-semibold text-sm">{signature}</p>
            </div>
          </div>
          ...
          <div className="hidden md:flex gap-6">
            ...
            <div className="flex-shrink-0">
              ...
              <div className="mt-3 text-center">
                <div className="flex items-center justify-center gap-1 mb-1">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <Star key={star} className="w-4 h-4 fill-current text-primary-400" />
                  ))}
                </div>
            ...
            <div className="flex-1">
              ...
              <div className="mb-4">
                ...
                <p className="text-primary-600 text-sm font-medium">{doctorCredentials}</p>
              </div>
                  ...
                  return (
                    <p
                      ...
                      className={`leading-relaxed ${
                        isHighlight
                          ? 'text-primary-800 font-semibold bg-primary-100/50 p-4 rounded-xl border-l-4 border-primary-500'
                          : 'text-gray-700'
                      }`}
                    >
                      {paragraph}
              ...
              <div className="mt-6 pt-4 border-t border-primary-100 flex items-center justify-between">
                <p className="text-primary-700 font-bold">{signature}</p>

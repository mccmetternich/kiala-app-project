/**
 * Script to create the "2026 Is My Year" article for Dr. Amy Heart
 */
...
async function createArticle() {
  try {
    ...
    const articlePath = join(__dirname, '../content/articles/2026-resolution-menopause.json');
    ...
    if (existingArticle.rows.length > 0) {
      ...
      await db.execute({
        ...
        args: [
          ...
          articleData.category,
          'https://images.unsplash.com/photo-1483058712412-4245e9b90334?w=1200&h=630&fit=crop', // Hero image: new year/fresh start
          articleData.featured ? 1 : 0,
          articleData.boosted ? 1 : 0,
          1, // published
          JSON.stringify(articleData.widget_config)

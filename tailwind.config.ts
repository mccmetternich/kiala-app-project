  ...
  theme: {
    extend: {
      colors: {
        ...
        accent: {
          50: 'var(--color-accent-50, #f9f6f2)',
          100: 'var(--color-accent-100, #f0ebe3)',
          200: 'var(--color-accent-200, #e2d5c7)',
          300: 'var(--color-accent-300, #d1bda8)',
          400: 'var(--color-accent-400, #c4a882)',
          500: 'var(--color-accent-500, #a3856e)',
          600: 'var(--color-accent-600, #8b7355)',
          700: 'var(--color-accent-700, #74604a)',
          800: 'var(--color-accent-800, #5c6b5e)',
          900: 'var(--color-accent-900, #4a554c)',
        },
        trust: {
